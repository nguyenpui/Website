                    ...
                    <div class="row">
                        <div class="product__main-img col-lg-4 col-md-4 col-sm-12">
                            <div class="product__main-img-primary">
                                <img src="front/images/product_13.png">
                            </div>

                            <div class="product__main-img-list">
                                <img src="front/images/product_13.png">
                                <img src="front/images/product_15.jpg">
                                <img src="front/images/product_16.jpg">
                                <img src="front/images/product_17.jpg">
                            </div>
                        </div>
                        ...
                        <div class="product__main-info col-lg-8 col-md-8 col-sm-12">
                            ...
                            <div class="product__main-info-cart">
                                ...
                                <div hr class="product__main-info-cart-btn-wrap">
                                ...
                                {{-- <form action="{{url('addcart', $product->id)}}" method="POST" >
                                    ...
                                    <input class="btn btn-primary" type="submit" style="width:100px" value="Add Cart">
                ...
                <aside class="product__aside col-lg-3 col-md-0 col-sm-0">
                    <div class="product__aside-top">
                        <div class="product__aside-top-item">
                            <img src="front/images/shipper.png">
                        ...
                        <div class="product__aside-top-item">
                            <img src="front/images/brand.png">
                            <div class="product__aside-top-item-text">
                                <p>
                                    Sản phẩm chính hãng
                                </p>
                        ...
                        <div class="product__aside-list">
                            <div class="product__aside-item product__aside-item--border">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_1.png" class="product__aside-img">
                                </div>
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_10.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                                        <h4 class="product__aside-link-heading">Mũ bảo hiểm fullface
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_3.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_7.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_4.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_6.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_5.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
                            ...
                            <div class="product__aside-item">
                                <div class="product__aside-img-wrap">
                                    <img src="front/images/product_12.png" class="product__aside-img">
                                </div>
                                <div class="product__aside-title">
                                    <a href="#" class="product__aside-link">
