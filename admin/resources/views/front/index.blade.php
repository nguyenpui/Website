                        ...
                        <div class="slide__left col-lg-8 col-md-0 col-sm-0">
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="front/images/banner_1.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="front/images/banner_8.jpg" class="d-block w-100" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                      <img src="front/images/banner_9.jpg" class="d-block w-100" alt="...">
                                    </div>
                                </div>
                            ...
                            <div class="slide__left-bottom">
                                <div class="slide__left-botom-one">
                                    <img src="front/images/banner_3.jpg" class="slide__left-bottom-one-img">
                                </div>
                                <div class="slide__left-bottom-two">
                                    <img src="front/images/banner_4.jpg" class="slide__left-bottom-tow-img">
                                </div>
                            </div>
                        </div>

                        <div class="slide__right col-lg-4 col-md-0 col-sm-0">
                            <img src="front/images/banner_2.jpg" class="slide__right-img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="bestselling__heading-wrap">
                    <img src="front/images/bestselling.png" alt="Sản phẩm bán chạy"
            ...
            <section class="row">
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_1.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                ...
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_8.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                    <div class="bestselling__product-text">
                        <h3 class="bestselling__product-title">
                ...
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_3.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                    <div class="bestselling__product-text">
                        <h3 class="bestselling__product-title">
                ...
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_4.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                    <div class="bestselling__product-text">
                        <h3 class="bestselling__product-title">
                ...
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_5.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                    <div class="bestselling__product-text">
                        <h3 class="bestselling__product-title">
                ...
                <div class="bestselling__product col-lg-4 col-md-6 col-sm-12">
                    <div class="bestselling__product-img-box">
                        <img src="front/images/product_6.png" alt="Mũ bảo hiểm" class="bestselling__product-img">
                    </div>
                    <div class="bestselling__product-text">
                        <h3 class="bestselling__product-title">
            ...
            <div class="row bestselling__banner">
                ...
                <div class="bestselling__banner-left col-lg-6">
                    <img src="front/images/banner_5.jpg" alt="Banner quảng cáo"
                    class="bestselling__banner-left-img">
                </div>
                <div class="bestselling__banner-right col-lg-6">
                    <img src="front/images/banner_6.jpg" alt="Banner quảng cáo"
            ...
            <div class="row">
                <aside class="product__sidebar col-lg-3 col-md-0 col-sm-12">
                    ...
                    <nav class="product__sidebar-list">
                        ...
                        <div class="row">
                            <div class="product__sidebar-item col-lg-6">
                                <img src="front/images/product_4.png" alt="" class="product__sidebar-item-img">
                                <a href="" class="product__sidebar-item-name">Mũ bảo hiểm LS2</a>
                            </div>
                            <div class="product__sidebar-item col-lg-6">
                                <img src="front/images/product_3.png" class="product__sidebar-item-img">
                                <a href="" class="product__sidebar-item-name">Mũ bảo hiểm Yohe</a>
                            </div>
                            <div class="product__sidebar-item col-lg-6">
                                <img src="front/images/product_2.png" alt="" class="product__sidebar-item-img">
                                <a href="" class="product__sidebar-item-name">Mũ bảo hiểm AGU</a>
                            </div>
                            <div class="product__sidebar-item col-lg-6">
                                <img src="front/images/product_11.png" alt="" class="product__sidebar-item-img">
                    ...
                    <div class="product__sidebar-img-wrap">
                        ...
                        <!-- <img src="front/images/banner_7.jpg" alt="" class="product__sidebar-img"> -->
                    </div>
                </aside>
                ...
                <article class="product__content col-lg-9 col-md-12 col-sm-12">
                    ...
                    <div class="row product__panel">
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_13.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                                    <a href="{{route('product')}}" class="product__panel-link">Mũ Fullface YOHE 967 2 Kính 2019 chất chơi</a>
                                </h3>
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_3.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                                    <a href="#" class="product__panel-link">Mũ bảo hiểm LS2 đẹp
                                    chính hãng</a>
                                </h3>
                                <div class="product__panel-rate-wrap">
                                    <i class="fas fa-star product__panel-rate"></i>
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_7.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                                    <a href="#" class="product__panel-link">Mũ bảo hiểm mới nhất
                                    2020</a>
                                </h3>
                                <div class="product__panel-rate-wrap">
                                    <i class="fas fa-star product__panel-rate"></i>
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_1.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_4.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_11.png" alt="" class="product__panel-img" width="110">
                                </div>
                                <h3 class="product__panel-heading">
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                                <div class="product__panel-img-wrap">
                                    <img src="front/images/product_8.png" alt="" class="product__panel-img">
                                </div>
                                <h3 class="product__panel-heading">
                                    <a href="#" class="product__panel-link">Mũ bảo hiểm fullface
                                    AGU kính mới</a>
                        ...
                        <div class="product__panel-item col-lg-3 col-md-4 col-sm-6">
                            <div class="product__panel-item-wrap">
                               <div class="product__panel-img-wrap">
                                <img src="front/images/product_9.png" alt="" class="product__panel-img">
                            </div>
                            <h3 class="product__panel-heading">
                                <a href="#" class="product__panel-link">Mũ bảo hiểm fullface
                                ROC màu trắng</a>
        ...
        <div class="container">
            ...
            <div class="row bg-white">
                <div class="product__panel-item col-lg-2 col-md-3 col-sm-6">
                    <div class="product__panel-img-wrap">
                        <img src="front/images/product_10.png" alt="" class="product__panel-img">
                    </div>
                    <h3 class="product__panel-heading">
            ...
            <article class="row posts__list">
                <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                    <div class="posts__item-img">
                        <img src="front/images/product_1.png">
                    </div>
...
Nhat Nguyen
                ...
                <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                    <div class="posts__item-img">
                        <img src="front/images/post_1.jpg">
                    </div>
                    <h3 class="posts__item-heading">
                        <a href="" class="posts__item-title">
...
Nhat Nguyen
                ...
                <div class="posts__item col-lg-3 col-md-6 col-sm-6">
                    <div class="posts__item-img">
                        <img src="front/images/post_2.jpg">
                    </div>
                    <h3 class="posts__item-heading">
                        <a href="#" class="posts__item-title">
